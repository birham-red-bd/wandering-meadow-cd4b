...
```
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-meadow-cd4b
```

A live public deployment of this template is available at [https://wandering-meadow-cd4b.templates.workers.dev](https://wandering-meadow-cd4b.templates.workers.dev)
